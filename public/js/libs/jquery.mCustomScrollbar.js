...
/*!****************************************************************!*\
  !*** ./resources/js/assets/js/libs/jquery.mCustomScrollbar.js ***!
  \****************************************************************/
...
(function ($) {
  ...
  var methods = {
    ...
    scrolling: function scrolling(mCustomScrollBox, mCSB_container, mCSB_draggerContainer, mCSB_dragger, mCSB_buttonUp, mCSB_buttonDown, mCSB_buttonLeft, mCSB_buttonRight) {
      var $this = $(this);
      ...
      if ($this.data("scrollButtons_enable")) {
        if ($this.data("scrollButtons_scrollType") === "pixels") {
          var PixelsScrollTo = function PixelsScrollTo(to) {
          ...
          var ScrollButtonsSpeed = function ScrollButtonsSpeed() {
          ...
          if ($this.data("horizontalScroll")) {
            ...
            if (!$this.data("bindEvent_buttonsContinuous_x")) {
              ...
              var mCSB_buttonRight_stop = function mCSB_buttonRight_stop(e) {
                e.preventDefault();
              ...
              var mCSB_buttonLeft_stop = function mCSB_buttonLeft_stop(e) {
                e.preventDefault();
            ...
            if (!$this.data("bindEvent_buttonsContinuous_y")) {
              ...
              var mCSB_buttonDown_stop = function mCSB_buttonDown_stop(e) {
                e.preventDefault();
              ...
              var mCSB_buttonUp_stop = function mCSB_buttonUp_stop(e) {
                e.preventDefault();
    ...
    scrollTo: function scrollTo(_scrollTo, options) {
      var $this = $(this),
          defaults = {
        moveDragger: false,
        trigger: "external",
      ...
      if (!mCSB_container.hasClass("mCS_no_scrollbar")) {
        ...
        if (_scrollTo || _scrollTo === 0) {
          if (typeof _scrollTo === "number") {
            /*if integer, scroll by number of pixels*/
            if (options.moveDragger) {
              /*scroll dragger*/
              draggerScrollTo = _scrollTo;

              if ($this.data("horizontalScroll")) {
                _scrollTo = mCSB_dragger.position().left * $this.data("scrollAmount");
              } else {
                _scrollTo = mCSB_dragger.position().top * $this.data("scrollAmount");
              }

              draggerSpeed = 0;
            } else {
              /*scroll content by default*/
              draggerScrollTo = _scrollTo / $this.data("scrollAmount");
            }
          } else if (typeof _scrollTo === "string") {
            ...
            if (_scrollTo === "top") {
              /*scroll to top*/
              target = 0;
            } else if (_scrollTo === "bottom" && !$this.data("horizontalScroll")) {
              /*scroll to bottom*/
              target = mCSB_container.outerHeight() - mCustomScrollBox.height();
            } else if (_scrollTo === "left") {
              /*scroll to left*/
              target = 0;
            } else if (_scrollTo === "right" && $this.data("horizontalScroll")) {
              /*scroll to right*/
              target = mCSB_container.outerWidth() - mCustomScrollBox.width();
            } else if (_scrollTo === "first") {
              /*scroll to first element position*/
              target = $this.find(".mCSB_container").find(":first");
            } else if (_scrollTo === "last") {
              /*scroll to last element position*/
              target = $this.find(".mCSB_container").find(":last");
            } else {
              /*scroll to element position*/
              target = $this.find(_scrollTo);
            }

            if (target.length === 1) {
              /*if such unique element exists, scroll to it*/
              if ($this.data("horizontalScroll")) {
                _scrollTo = target.position().left;
              } else {
                _scrollTo = target.position().top;
              }

              draggerScrollTo = _scrollTo / $this.data("scrollAmount");
            } else {
              draggerScrollTo = _scrollTo = target;
            }
          }
          /*scroll to*/
          ...
          if ($this.data("horizontalScroll")) {
            ...
            if (draggerScrollTo < 0) {
              ...
              _scrollTo = mCustomScrollBox.width() - mCSB_container.outerWidth();
              clearInterval($this.data("mCSB_buttonScrollRight"));
            ...
            if (snapAmount) {
              _scrollTo = Math.round(_scrollTo / snapAmount) * snapAmount - $this.data("snapOffset");
            }
            /*scrolling animation*/


            functions.mTweenAxis.call(this, mCSB_dragger[0], "left", Math.round(draggerScrollTo), draggerSpeed, options.scrollEasing);
            functions.mTweenAxis.call(this, mCSB_container[0], "left", Math.round(_scrollTo), contentSpeed, options.scrollEasing, {
            ...
            if (draggerScrollTo < 0) {
              ...
              _scrollTo = mCustomScrollBox.height() - mCSB_container.outerHeight();
              clearInterval($this.data("mCSB_buttonScrollDown"));
            ...
            functions.mTweenAxis.call(this, mCSB_container[0], "top", Math.round(_scrollTo), contentSpeed, options.scrollEasing, {
              onStart: function onStart() {
                if (options.callbacks && !$this.data("mCS_tweenRunning")) {
                  callbacks("onScrollStart");
                }
    ...
    disable: function disable(resetScroll) {
      var $this = $(this),
          mCustomScrollBox = $this.children(".mCustomScrollBox"),
          mCSB_container = mCustomScrollBox.children(".mCSB_container"),
          mCSB_scrollTools = mCustomScrollBox.children(".mCSB_scrollTools"),
    ...
    /*js animation tween*/
    mTweenAxis: function mTweenAxis(el, prop, to, duration, easing, callbacks) {
    ...
    mTweenAxisStop: function mTweenAxisStop(el) {
      if (el._id == null) {
        return;
      }
