...
/*!****************************************************!*\
  !*** ./resources/js/assets/js/libs/TimeCircles.js ***!
  \****************************************************/
...
!function (t) {
  ...
  Object.keys || (Object.keys = function () {
    ...
    var t = Object.prototype.hasOwnProperty,
      ...
      toString: null
        ...
        i = a.length;
    return function (n) {
      if ("object" != _typeof(n) && ("function" != typeof n || null === n)) throw new TypeError("Object.keys called on non-object");
      var s,
          r,
          o = [];
  ...
  _.prototype.clearListeners = function () {
    ...
    void 0 !== _typeof(s) && d.setTimeout(function () {
  ...
  b.prototype.getInstance = function (e) {
    ...
    if ("undefined" == typeof i && (i = n(), t(e).attr("data-tc-id", i)), "undefined" == typeof p[i]) {
      var s = this.options,
          r = t(e).data("options");
      "string" == typeof r && (r = JSON.parse(r)), "object" == _typeof(r) && (s = t.extend(!0, {}, this.options, r)), a = new _(e, s), p[i] = a;
