...
"use strict";
/*!*****************************************!*\
  !*** ./resources/js/assets/js/theme.js ***!
  \*****************************************/
...
(function ($) {
  ...
  popup_wishlist(); //Menu Responsive
  ...
  jQuery(document).ready(function () {
    ...
    detail_gallery(); //Product Quick View
    ...
    $('.post-zoom-link').fancybox(); //Add Cart Special
